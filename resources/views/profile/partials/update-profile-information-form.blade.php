<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="gebruikersnaam" name="gebruikersnaam" type="text" class="mt-1 block w-full" :value="old('gebruikersnaam', Auth::user()->Gebruikersnaam)" required autofocus autocomplete="gebruikersnaam" />
