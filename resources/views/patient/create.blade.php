        ...
        @endif
            ...
            <div class="grid grid-cols-2 gap-4 mb-6">
                <div class="input-container">
                    ...
                    <input type="text" name="voornaam" id="Voornaam" value="{{ old('voornaam') }}" 
                        ...
                        @error('voornaam') border-red-500 @enderror" required>
                </div>
                <div class="input-container">
                    @error('tussenvoegsel')
                        <span class="error-message">{{ $message }}</span>
                ...
                <div class="input-container">
                    ...
                    <input type="text" name="achternaam" id="Achternaam" value="{{ old('achternaam') }}" 
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg 
                        @error('achternaam') border-red-500 @enderror" required>
                </div>
                <div class="input-container">
                    @error('geboortedatum')
                        <span class="error-message">{{ $message }}</span>
                    ...
                    <input type="date" name="geboortedatum" id="Geboortedatum" value="{{ old('geboortedatum') }}" 
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg 
                        @error('geboortedatum') border-red-500 @enderror" required>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4 mb-6">
                <div class="input-container">
                    ...
                    <input type="text" name="mobiel" id="Mobiel" value="{{ old('mobiel') }}" 
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg 
                        @error('mobiel') border-red-500 @enderror" required>
                </div>
                <div class="input-container">
                    @error('email')
                        <span class="error-message">{{ $message }}</span>
                ...
                <div class="input-container">
                    ...
                    <input type="text" name="postcode" id="Postcode" value="{{ old('postcode') }}" 
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg 
                        @error('postcode') border-red-500 @enderror" required>
                </div>
                <div class="input-container">
                    @error('plaats')
                        <span class="error-message">{{ $message }}</span>
                    ...
                    <input type="text" name="plaats" id="Plaats" value="{{ old('plaats') }}" 
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg 
                        @error('plaats') border-red-500 @enderror" required>
                </div>
                <div class="input-container">
                    @error('huisnummer')
                        <span class="error-message">{{ $message }}</span>
                    ...
                    <input type="text" name="huisnummer" id="Huisnummer" value="{{ old('huisnummer') }}" 
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg 
                        @error('huisnummer') border-red-500 @enderror" required>
                </div>
                <div class="input-container">
                    @error('toevoeging')
                        <span class="error-message">{{ $message }}</span>
                ...
                <div class="input-container">
                    ...
                    <input type="text" name="straatnaam" id="Straatnaam" value="{{ old('straatnaam') }}" 
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg 
                        @error('straatnaam') border-red-500 @enderror" required>
                </div>
            </div>
            ...
            <div class="input-container mb-6">
                ...
                <textarea name="medisch_dossier" id="MedischDossier" rows="4" 
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg 
                    @error('medisch_dossier') border-red-500 @enderror" required>{{ old('medisch_dossier') }}</textarea>
            </div>
